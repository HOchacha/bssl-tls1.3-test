...
export BUILD_WRAPPER_SCRIPT="bazel-out/k8-fastbuild/bin/bssl-compat/bssl-compat_foreign_cc/wrapper_build_script.sh"
export BUILD_SCRIPT="bazel-out/k8-fastbuild/bin/bssl-compat/bssl-compat_foreign_cc/build_script.sh"
export BUILD_LOG="bazel-out/k8-fastbuild/bin/bssl-compat/bssl-compat_foreign_cc/CMake.log"
touch $BUILD_LOG
